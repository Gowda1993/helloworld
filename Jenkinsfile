                    ...
                    steps {
                        script {
                            withCredentials([usernamePassword(credentialsId: '0c0af0dc-2acb-4f30-be59-5a66d40cb34f', usernameVariable: 'DOCKER_USERNAME', passwordVariable: 'DOCKER_PASSWORD')]) {
                                ...
                                sh 'docker run -d -p 8090:8080 --name tomcat-qa shashidhar09/myjenkinsprivate:${BUILD_NUMBER}'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        script {
                            withCredentials([usernamePassword(credentialsId: '0c0af0dc-2acb-4f30-be59-5a66d40cb34f', usernameVariable: 'DOCKER_USERNAME', passwordVariable: 'DOCKER_PASSWORD')]) {
                                ...
                                sh 'docker run -d -p 8090:8080 --name tomcat-prod shashidhar09/myjenkinsprivate:${BUILD_NUMBER}'
                            }
                        }
                    }
                }
